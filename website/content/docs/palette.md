...
Tinycast uses one fixed light appearance. The glass and black-alpha ink are tuned together, so it does
not follow macOS between Light and Dark.

The [Toggle System Appearance](/docs/launcher/system-actions) action changes _macOS itself_ while
Tinycast remains light.
