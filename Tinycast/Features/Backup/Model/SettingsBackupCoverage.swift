...
enum SettingsBackupCoverage {
    ...
    static let mirrored: [String: AppSettingsKey] = [
        ...
        "taskCaptureOmniFocusEnabled": .taskCaptureOmniFocusEnabled,
        "taskCaptureTextFlowEnabled": .taskCaptureTextFlowEnabled,
        "taskCaptureOmniFocusSuggestions": .taskCaptureOmniFocusSuggestions,
