...
enum AppSettingsKey: String, CaseIterable {
    ...
    case taskCaptureOmniFocusEnabled = "taskCaptureOmniFocusEnabled"
    case taskCaptureTextFlowEnabled = "taskCaptureTextFlowEnabled"
    case taskCaptureOmniFocusSuggestions = "taskCaptureOmniFocusSuggestions"
